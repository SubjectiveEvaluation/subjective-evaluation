...
sent = open('studentAns.txt', 'rb').readlines()#creates a list in which each element is one line of the file
#print 'sent'
#print sent
...
i,x,count= 1,0,1
sqr,sqrrt=0,0
value2=[] #list to store values of TfIdf from table
...
#				print '************************************************'
				...
				for row in cur.execute("SELECT TfIdf FROM OriginalAnswers WHERE Words = ?", [w]):
					variable = row[0]
					print "tfidf:",
					print variable
					value2.append(variable)
